...
from test_utils import (
    load_test_data,
    call_cloud_api_batch,
    save_results,
    CORE_MODELS_CONFIG
)

def run_deepseek_coreonly():
    print("=" * 60)
    print("DeepSeek CoreOnly 测试")
    print("=" * 60)
    ...
    # 保存结果
    save_results(model_key, "coreonly", results)

    print(f"\n✅ DeepSeek CoreOnly 测试完成")
    print(f"   处理样本数: {len(results)}")

if __name__ == "__main__":
    run_deepseek_coreonly()
